      ...
      <div className="flex flex-col items-center">
        ...
        <FadeDiv>
          <SectionContent>
            ...
            <p>
              É com grande alegria que estamos nos preparando para o nosso
              grande dia, o nosso casamento! Gostaríamos de expressar o quanto
              significa para nós tê-los presentes nesse momento especial de
              nossas vidas.
            </p>
          </SectionContent>
        </FadeDiv>
        ...
        <FadeDiv>
          ...
          <SectionContent>
            <p>
              Mais do que qualquer presente material, o que realmente
              valorizamos é ter vocês ao nosso lado enquanto embarcamos nesta
        ...
        <FadeDiv>
          ...
          <SectionContent>
            <div className="flex flex-col items-center justify-between gap-4 lg:flex-row">
              ...
              <iframe
                title="location map"
                className="invisible w-1/2 rounded-md border border-wedding lg:visible"
